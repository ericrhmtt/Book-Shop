        ...
        <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 item-center gap-6">
                ...
                <div data-aos="slide-up" data-aos-duration="300" className="flex flex-col justify-center  gap-6 sm:pt-0">
                    ...
                    <p className='text-sm text-gray-500 tracking-wide leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque aliquam, modi eum fugit molestias nulla veritatis officiis libero ea nisi!</p>
